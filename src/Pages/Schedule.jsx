...
const Schedule = () => {
  ...
  piketGroup = [
    ["Ardit", "Audric", "Faisal", "Iurie", "Pedro", "Shabila"],
    ["Azka", "Girtianda", "Kheisya", "Rakan", "Reyhan", "Zain"],
    ["Aji", "Arya", "Fairuz", "Ghani", "Kamelia", "Zaidan"],
    ["Abdan", "Chandra", "Faris", "Ridho", "Shera", "Zaky"],
    ["Dzaky", "Faza", "Gaizka", "Laila", "Rafif", "Rendra", "Rasendria"],
  ];

    ...
    <div className="z-1 relative h-auto lg:overflow-hidden">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        >
          ...
          <img
            src="LineHorizontalPendek.svg"
            className="relative top-3"
          />
          <img
            src="LineHorizontalPendek.svg"
            className="relative top-3 hidden lg:flex"
          />
          <img
            src="LineHorizontalPendek.svg"
            className="relative top-3 hidden lg:flex"
